/* -----------------------------------------------------------
   🔹  ThemeSetup — step-2 screen (select theme & navigate)
   ----------------------------------------------------------- */
...
> = {
  diversified: {
    ...
    accent: "#FFE38D",
    groupSrc: group1,
    route: "/invest/autoinvest/confirm?theme=diversified",
    iconName: "pie-chart",
  },
  growth: {
    ...
    accent: "#10B981",
    groupSrc: group2,
    route: "/invest/autoinvest/confirm?theme=growth",
  ...
  income: {
    ...
    accent: "#74a1d6",
    groupSrc: group3,
    route: "/invest/autoinvest/confirm?theme=income",
...
const ThemeSetup: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* theme cards: navigate on press */}
      {(Object.keys(themes) as ThemeKey[]).map((key) => {
        const { title, desc, accent, groupSrc, route } = themes[key];
        return (
          <ThemeCard
            key={key}
            id={key}
            ...
            accentColor={accent}
            groupSrc={groupSrc}
            selected={false} // no highlight state
