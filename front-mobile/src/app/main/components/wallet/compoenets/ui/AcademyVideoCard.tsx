...
export default function AcademyVideoCard() {
  return (
    <View className="mx-4 rounded-2xl overflow-hidden border border-gray-200 bg-[#F9FAFB] shadow-sm">
      {/* Top Ribbon */}
      <View
      ...
      >
        ...
        <Text className="text-base font-medium text-gray-900">6 mins</Text>
      </View>
