...
interface DirectHealthCheckButtonProps
...
export function DirectHealthCheckButton({
  label = 'Database Health',
  className,
  variant = 'outline',
  size = 'default',
}: DirectHealthCheckButtonProps) {
  ...
  const checkHealth = async () => {
    try {
      ...
      // Directly use the production health check endpoint
