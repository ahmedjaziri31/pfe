...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 15, 2025 at 02:05 PM
...
CREATE TABLE `auto_invest_plans` (
  ...
  `currency` enum('TND','EUR') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'TND',
  `theme` enum('growth','income','index','balanced') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `status` enum('active','paused','cancelled') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'active',
  `deposit_day` int NOT NULL,
  `payment_method_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `risk_level` enum('low','medium','high') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'medium',
  `preferred_regions` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `excluded_property_types` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
...
CREATE TABLE `auto_reinvest_plans` (
  ...
  `theme` enum('growth','income','index','balanced','diversified') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'balanced',
  `risk_level` enum('low','medium','high') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'medium',
  `preferred_regions` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `excluded_property_types` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  ...
  `reinvestment_frequency` enum('immediate','weekly','monthly') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'monthly',
...
(20, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjMyLCJlbWFpbCI6ImFobWVkamF6aXJpNTFAZ21haWwuY29tIiwicm9sZSI6InVzZXIiLCJpYXQiOjE3NDk1NDU4ODUsImV4cCI6MTc0OTU0OTQ4NX0.-9ONeERMBh9bsObGwDyKW3rN2YxPHEayzoRkUJUTsvY', '2025-06-10 09:58:05', '2025-06-10 08:58:20'),
(21, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjMwLCJlbWFpbCI6ImFobWVkamF6aXJpNDFAZ21haWwuY29tIiwicm9sZSI6InN1cGVyYWRtaW4iLCJpYXQiOjE3NDk1NDU5MTIsImV4cCI6MTc0OTU0OTUxMn0.kJvbmlEGPyfuAwQhEAIwgSO4RrB91MKEOpDiHi3OKXk', '2025-06-10 09:58:32', '2025-06-10 08:59:56');
...
CREATE TABLE `founders` (
  `id` int NOT NULL,
  `image_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `linkedin_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `investments` (
  ...
  `status` enum('pending','confirmed','failed','cancelled') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'pending',
  `user_address` varchar(42) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `paymee_ref` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `payment_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `tx_hash` varchar(66) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `currency` varchar(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'TND',
  `payment_method` enum('wallet','card','bank_transfer') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'wallet',
...
CREATE TABLE `payments` (
  ...
  `saved_payment_method_id` int DEFAULT NULL,
  ...
  `payme_transaction_id` int DEFAULT NULL COMMENT 'PayMe transaction ID from webhook',
  ...
  `webhook_data` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin COMMENT 'Raw webhook data from PayMe',
...
CREATE TABLE `projects` (
  ...
  `status` enum('Pending','Active','Funded','Completed','Cancelled') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Pending',
  `property_status` enum('available','under_review','sold_out','rented') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'under_review',
  `location` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `coordinates` point DEFAULT NULL,
  `address_details` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `property_size` decimal(10,2) DEFAULT NULL,
  `property_type` enum('residential','commercial','industrial','land') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `investment_period` int DEFAULT NULL COMMENT 'In months',
  `minimum_investment` decimal(18,2) DEFAULT NULL,
  `image_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `cloudinary_public_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
(7, 'Modern Business Center', 'State-of-the-art office complex designed for modern businesses. Features flexible office spaces, conference facilities, high-speed internet infrastructure, and premium location in the emerging business district.', 2800000.00, 1004000.00, 'Active', 'available', 'Sfax, Tunisia', NULL, NULL, 950.00, 'commercial', NULL, NULL, 2023, '{\"conferenceRooms\":true,\"highSpeedInternet\":true,\"parking\":true,\"security\":true,\"elevator\":true,\"airConditioning\":true,\"cafeteria\":true}', 13.20, 10.10, 45, 8000.00, 'https://images.unsplash.com/photo-1497366811353-6870744d04b2?w=800&h=600&fit=crop&auto=format', NULL, 21, 0, '2025-06-03 01:22:58', '2025-06-10 02:29:04'),
...
(9, 'Heritage Renovation Project', 'Restoration of a historic building in Tunis Medina, converting it into boutique apartments while preserving traditional architecture. This unique project combines cultural heritage with modern amenities.', 2200000.00, 2200000.00, 'Funded', 'sold_out', 'Medina, Tunis', NULL, NULL, 95.00, 'residential', 2, 1, 1890, '{\"historicalSignificance\":true,\"traditionalArchitecture\":true,\"courtyardGarden\":true,\"security\":true}', 9.50, 6.80, 48, 4000.00, 'https://images.unsplash.com/photo-1518780664697-55e3ad937233?w=800&h=600&fit=crop&auto=format', NULL, 21, 0, '2025-06-03 01:22:59', '2025-06-03 01:22:59'),
...
CREATE TABLE `project_documents` (
  ...
  `cloudinary_public_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `document_type` enum('legal','financial','technical','marketing','other') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_by` int DEFAULT NULL,
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `referrals` (
  ...
  `status` enum('pending','qualified','rewarded') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'pending',
  ...
  `currency` enum('TND','EUR') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `rental_payouts` (
  ...
  `reinvest_transaction_id` int DEFAULT NULL,
  `auto_reinvest_plan_id` int DEFAULT NULL,
  `status` enum('pending','paid','reinvested','partially_reinvested') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'pending',
  `notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'superadmin', '[\"all\"]', 'Super Administrator with full system access', '2025-05-28 13:10:21', '2025-06-12 02:26:48'),
(2, 'admin', '[\"manage_users\",\"view_users\",\"edit_users\",\"view_reports\",\"manage_content\",\"view_dashboard\",\"manage_settings\"]', 'Administrator with management access', '2025-05-28 13:10:21', '2025-06-12 02:26:48'),
(3, 'agent', '[\"view_dashboard\",\"view_assigned_tasks\",\"manage_own_profile\",\"view_reports\"]', 'Support agent with limited access', '2025-05-28 13:10:21', '2025-06-12 02:26:48'),
...
CREATE TABLE `saved_payment_methods` (
  ...
  `type` enum('stripe','payme','apple_pay','google_pay') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'stripe',
  `stripe_payment_method_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `stripe_customer_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `card_brand` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `card_last4` varchar(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `card_exp_month` int DEFAULT NULL,
  `card_exp_year` int DEFAULT NULL,
  `payme_phone_number` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payme_account_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `google_pay_token` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `apple_pay_token` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `transactions` (
  ...
  `auto_invest_plan_id` int DEFAULT NULL,
  `type` enum('deposit','withdrawal','reward','investment','rent_payout','referral_bonus') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `amount` decimal(15,2) NOT NULL,
  `currency` enum('USD','EUR','TND') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `balance_type` enum('cash','rewards') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `metadata` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `processed_at` datetime DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  `auto_reinvest_plan_id` int DEFAULT NULL,
  `tx_hash` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Blockchain transaction hash',
...
CREATE TABLE `users` (
  ...
  `reset_code` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `reset_code_expires` datetime DEFAULT NULL,
  `is_verified` tinyint(1) DEFAULT '0',
  `role_id` int DEFAULT NULL,
  `approval_status` enum('unverified','pending','approved','rejected') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'unverified',
  `profile_picture` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '',
  `cloudinary_public_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '',
  ...
  `clerk_user_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  `phone` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `account_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'Individual Account',
  ...
  `global_users` int DEFAULT '0',
  `global_countries` int DEFAULT '0',
  `pending_email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `email_verification_code` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `email_verification_expires` datetime DEFAULT NULL,
  `last_email_change` datetime DEFAULT NULL,
  `phone_verification_code` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pending_phone` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `referral_stats` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `investment_preferences` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `investment_preference` enum('all','local') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'all',
  `investment_region` enum('Tunisia','France') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Tunisia',
  `twoFactorSecret` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Base32 encoded TOTP secret for 2FA',
  `twoFactorEnabled` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Whether 2FA is enabled for this user',
  `backupCodes` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin COMMENT 'JSON array of backup codes for 2FA recovery',
  ...
  `signup_verification_code` varchar(6) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `signup_verification_expires` datetime DEFAULT NULL,
  `google_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Google user ID for OAuth authentication',
  `is_google_user` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Flag indicating if user signed up with Google',
  `photo` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'User profile photo URL from Google or uploaded'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `verifications` (
  ...
  `identity_status` enum('pending','under_review','approved','rejected') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'pending',
  `passport_image_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `selfie_image_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `identity_submitted_at` datetime DEFAULT NULL,
  `identity_reviewed_at` datetime DEFAULT NULL,
  `identity_rejection_reason` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `address_status` enum('pending','under_review','approved','rejected') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'pending',
  `address_image_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `address_submitted_at` datetime DEFAULT NULL,
  `address_reviewed_at` datetime DEFAULT NULL,
  `address_rejection_reason` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `overall_status` enum('incomplete','under_review','verified','rejected') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'incomplete',
  `backoffice_request_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `wallets` (
  ...
  `currency` enum('USD','EUR','TND') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'TND',
...
(11, 32, 214.00, 0.00, 'TND', '2025-06-10 08:54:41', '2025-06-10 00:58:33', '2025-06-10 08:54:41'),
...
CREATE TABLE `wallet_transactions` (
  ...
  `transaction_type` enum('deposit','withdrawal','refund') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `payment_method` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `amount` decimal(15,2) NOT NULL,
  `currency` varchar(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'TND',
  `status` enum('pending','completed','failed','cancelled') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'pending',
  `user_address` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `payme_token` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `payme_order_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `payme_transaction_id` int DEFAULT NULL,
  ...
  `withdrawal_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
