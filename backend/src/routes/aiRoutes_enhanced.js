 ...
 * /api/ai/chat:
 *   post:
 *     summary: Send a message to the AI chatbot with role-based context
 *     tags: [AI]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 ...
 * /api/ai/backoffice:
 *   post:
 *     summary: Send a natural language query to the backoffice AI with role-based access control
 *     tags: [AI]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
